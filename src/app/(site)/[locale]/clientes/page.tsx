...
const order: Client["sector"][] = ["financeiro", "saude", "bebidas", "alimentar", "consumo", "retalho", "industria", "construcao", "transportes", "servicos", "ong", "arte", "eventos", "lazer", "tecnologia"];

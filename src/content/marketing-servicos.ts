...

  {
    ...
    fluxo: {
      ...
      capitulos: [
        ...
        { nome: { pt: "Três matrizes", en: "Three matrices" }, texto: { pt: "Cruzam-se os clusters em três matrizes: empregados por setor, volume de negócios por setor, setor por região. É onde se vê onde a sua carteira está forte e onde o mercado tem mais empresas parecidas por conquistar.", en: "The clusters are crossed in three matrices: headcount by sector, turnover by sector, sector by region. This is where you see where your base is strong and where the market has the most similar companies left to win." } },

...
export const SERVICOS_DE_MARKETING: ServicoDeMarketing[] = [
...

  {
    ...
    fluxo: {
      ...
      titulo: { pt: "Da sua carteira ao próximo cliente, em seis passos.", en: "From your customer list to your next customer, in six steps." },
      nota: {
        pt: "A análise de oportunidade de crescimento da carteira, com os dados da Informa D&B. Fazemo-la nós e devolvemo-la como lista de trabalho.",
        en: "The customer-base growth opportunity analysis, on Informa D&B data. We run it and hand it back as a working list.",
      },
      capitulos: [
        { nome: { pt: "A carteira", en: "The customer list" }, texto: { pt: "Começa com um ficheiro seu: a lista de clientes atuais, com nome e NIF. É tudo o que precisamos para arrancar.", en: "It starts with a file of yours: your current customers, with name and tax number. That is all we need to begin." } },
        { nome: { pt: "O mercado inteiro", en: "The whole market" }, texto: { pt: "A carteira entra na base da Informa D&B, com 1,6 milhões de empresas em Portugal. Mais de 90 % dos seus clientes são reconhecidos; os que faltam são, quase sempre, empresários em nome individual.", en: "Your list goes into the Informa D&B database, 1.6 million companies in Portugal. Over 90% of your customers are recognised; the rest are almost always sole traders." } },
        { nome: { pt: "Clusters e lookalikes", en: "Clusters and lookalikes" }, texto: { pt: "Cada cliente reconhecido traz o seu perfil: setor de atividade, número de empregados, volume de negócios, região. As empresas com o mesmo perfil que ainda não são suas clientes são os lookalikes.", en: "Each recognised customer brings its profile: sector, headcount, turnover, region. Companies with the same profile that are not yet your customers are the lookalikes." } },
        { nome: { pt: "Matrizes", en: "Matrices" }, texto: { pt: "Cruzam-se os clusters em várias matrizes: empregados por setor, volume de negócios por setor, setor por região, entre outras. É onde se vê onde a sua carteira está forte e onde o mercado tem mais empresas parecidas por conquistar.", en: "The clusters are crossed in several matrices: headcount by sector, turnover by sector, sector by region, among others. This is where you see where your base is strong and where the market has the most similar companies left to win." } },
        { nome: { pt: "O ranking", en: "The ranking" }, texto: { pt: "Sai uma lista ordenada por probabilidade de vir a ser cliente, com o valor potencial de cada empresa. Quantas são, quem são e quanto valem, antes de gastar um euro a falar com elas.", en: "Out comes a list ranked by the likelihood of becoming a customer, with each company's potential value. How many, who they are and what they are worth, before spending a euro talking to them." } },
        { nome: { pt: "A estratégia", en: "The strategy" }, texto: { pt: "A lista alimenta duas frentes ao mesmo tempo: a equipa comercial no terreno e o digital, com anúncios, LinkedIn e e-mail a falar às mesmas empresas, e a marca a chegar antes da chamada.", en: "The list feeds two fronts at once: the sales team in the field and digital, with ads, LinkedIn and email speaking to the same companies, and the brand arriving before the call." } },
      ],
      rotulos: {
        ficheiro: { pt: "carteira-clientes.xlsx", en: "customer-list.xlsx" },
        colEmpresa: { pt: "Empresa", en: "Company" },
        colNif: { pt: "NIF", en: "Tax no." },
        colVendas: { pt: "Vendas", en: "Sales" },
        mercado: { pt: "1,6 M empresas · Portugal", en: "1.6 M companies · Portugal" },
        reconhecidos: { pt: "> 90 % reconhecidos", en: "> 90% recognised" },
        eni: { pt: "não reconhecidos: empresários em nome individual", en: "not recognised: sole traders" },
        clientes: { pt: "clientes", en: "customers" },
        lookalikes: { pt: "lookalikes", en: "lookalikes" },
        eixos: { pt: "setor · empregados · volume de negócios · região", en: "sector · headcount · turnover · region" },
        matriz1: { pt: "empregados × setor", en: "headcount × sector" },
        matriz2: { pt: "volume de negócios × setor", en: "turnover × sector" },
        matriz3: { pt: "setor × região", en: "sector × region" },
        probabilidade: { pt: "probabilidade de vir a ser cliente", en: "likelihood of becoming a customer" },
        quantas: { pt: "quantas", en: "how many" },
        quem: { pt: "quem", en: "who" },
        valor: { pt: "valor potencial", en: "potential value" },
        terreno: { pt: "terreno", en: "field" },
        digital: { pt: "digital", en: "digital" },
        novos: { pt: "novos clientes", en: "new customers" },
        canaisTerreno: { pt: "chamada · visita · proposta", en: "call · visit · proposal" },
        canaisDigital: { pt: "anúncios · LinkedIn · e-mail · marca", en: "ads · LinkedIn · email · brand" },
        ilustrativo: { pt: "Desenho ilustrativo do processo", en: "Illustrative drawing of the process" },
      },
    },
...

  {
    ...
    faq: [
      { pergunta: { pt: "Com que ferramentas trabalham?", en: "Which tools do you work with?" }, resposta: { pt: "Com as vossas. A Jelly é agnóstica, e isso vem da génese: a casa cresceu a desenhar, a desenvolver e a integrar plataformas, websites e e-commerce, e esse trabalho ensina depressa que a ferramenta certa é a que a equipa usa e a que se liga ao resto. Somos parceiros Brevo, Mailchimp, Pipedrive e HighLevel, trabalhamos com HubSpot e com o que já lá estiver. A recomendação sai da vossa dimensão, dos dados que já têm e de quem vai mexer nisto todos os dias — nunca do catálogo.", en: "With yours. Jelly is tool-agnostic, and that comes from the beginning: the house grew up designing, building and integrating platforms, websites and e-commerce, and that work teaches you fast that the right tool is the one the team uses and the one that connects to everything else. We are Brevo, Mailchimp, Pipedrive and HighLevel partners, we work with HubSpot and with whatever is already in place. The recommendation comes from your size, the data you already have and who will be in there every day — never from the catalogue." } },

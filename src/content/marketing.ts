...
export const marketing = {
  ...
  lista: [
    ...
    },
    {
      ...
      servicos: [
        { nome: { pt: "Social Media", en: "Social Media" }, linha: { pt: "Gestão, conteúdos e comunidade.", en: "Management, content and community." }, sub: "social-media" },
        { nome: { pt: "Vídeo e Audiovisual", en: "Video and Audiovisual" }, linha: { pt: "Jelly.Studio, da ideia à pós-produção.", en: "Jelly.Studio, from idea to post-production." }, sub: "video-audiovisual" },
        { nome: { pt: "Conteúdo editorial e Inbound", en: "Editorial content and Inbound" }, linha: { pt: "Artigos, guias e newsletters que alimentam o SEO e o GEO.", en: "Articles, guides and newsletters that feed SEO and GEO." }, sub: "conteudo-editorial-inbound" },
      ],
    ...
    },
    {
      ...
      servicos: [
        { nome: { pt: "Influencers e Creators (UGC)", en: "Influencers and Creators (UGC)" }, linha: { pt: "Seleção, briefing, contratos e medição.", en: "Selection, briefing, contracts and measurement." }, sub: "influencers-creators-ugc" },
        { nome: { pt: "Digital PR e Assessoria de Imprensa", en: "Digital PR and Media Relations" }, linha: { pt: "Press releases e relações com os media.", en: "Press releases and media relations." }, sub: "digital-pr-assessoria-imprensa" },
      ],
    ...
    },
    {
      ...
      servicos: [
        { nome: { pt: "Marketing Automation e Lifecycle", en: "Marketing Automation and Lifecycle" }, linha: { pt: "E-mail, nurturing e jornadas ligadas ao CRM.", en: "Email, nurturing and journeys wired to the CRM." }, sub: "marketing-automation-lifecycle" },
        { nome: { pt: "Analytics, Atribuição e CRO", en: "Analytics, Attribution and CRO" }, linha: { pt: "Eventos, atribuição e testes na página.", en: "Events, attribution and on-page testing." }, sub: "analytics-atribuicao-cro" },
      ],
